...
`rquality` is centered on data quality work in R. The technical target is: Run table checks for nulls, ranges, uniqueness, and cross-field rules.
...
The score is deterministic. The current threshold is 158. Risk has a penalty of 5, latency has a penalty of 2, and weight contributes a bonus of 3.
