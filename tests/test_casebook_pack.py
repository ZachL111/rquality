"""Regression checks for the rquality casebook."""
...
from casebook.harness import assert_expected, rquality_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(rquality_summary(), assert_expected())
